<?php 
    ...
    if(isset($_POST["resetpass"])){
        if(empty($_POST["cashierEmail"])){
            $message = '<label>All fields are required</label>';
        }
        else{
            $query = "SELECT * FROM cashiertable WHERE cashierEmail = :cashierEmail";
            ...
            if($count>0){
                $_SESSION["cashierEmail"] = $_POST["cashierEmail"];
                ...
                echo "<script>alert('Cahshier Email does not exist. Please try again');</script>";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputCashierEmail" type="text" aria-describedby="emailHelp" placeholder="Enter Email" name="cashierEmail" required />
                                            </div>
