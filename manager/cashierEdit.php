<?php
    ...
    if(isset($_POST['editcashier'])){
        $statement = $connect->prepare("UPDATE cashiertable SET cashierEmail = '".$_POST['cashierEmail']."', cashierUsername = '".$_POST['cashierUsername']."', cashierPassword = '".$_POST['cashierPassword']."' WHERE cashierID = ".$_GET["cashierID"]);
        $statement->execute();
    ...
    //select/read code
    $statement = $connect->prepare("SELECT * FROM cashiertable WHERE cashierID=".$_GET["cashierID"]);
    $statement->execute();
    $statement->fetchALL();
    $connect = null;
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="card-header"><h3 class="mt-4">Edit Cashier ID: <?php echo $_GET["cashierID"]; ?></h3></div>
                    <div class="card-body">
                        <form  name="transaction_form" method="post" autocomplete="off">
                            ...
                            <div class="form-group mt-4 mb-0">
                                <input type="submit" name="editcashier" class="btn btn-primary btn-block" value="Edit Cashier"/>
                            </div>
                        </form>
                    </div>
                </main>
